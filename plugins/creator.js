...
if (command == 'owner') {
 let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp;Saya Owner Atsair;Bot;;Md\nFN:Saya Owner Atsair Bot WhatsApp, Md\nNICKNAME:👑 Owner Atsair Bot\nORG:Wudy\nTITLE:soft\nitem1.TEL;waid=6289510402229+62 895-1040-2229\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:https://s.id/Cerdasin62\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET: Atsairbotz@mail.com\nitem3.X-ABLabel:💌 Mail Owner Atsair 𝗕𝗼t𝘇\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 20 Desember 2007\nEND:VCARD`
...
if (command == 'creator') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `maxxybotz@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://MaxxyBotz.github.io/`, `👤 Gada pawang nih senggol dong 😔`],
